...
public class SimCardController {
    ...
    @PutMapping("/update")
    public ResponseEntity<?> update(@RequestBody @Valid SimCardUpdateDto simCardUpdateDto) {
    ...
    @GetMapping("/all/unbooked")
    public ResponseEntity<?> getAllUnbooked() {
        return ResponseEntity.ok(simCardService.getUnbookedNumbers());
    }
